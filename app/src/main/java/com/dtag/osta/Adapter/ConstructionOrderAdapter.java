...
import com.dtag.osta.databinding.PreviewItemBinding;
...
public class ConstructionOrderAdapter extends RecyclerView.Adapter<ConstructionOrderAdapter.ServicesViewHolder>
    ...
    public ConstructionOrderAdapter(Context context) {
    ...
    public ServicesViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new ServicesViewHolder(PreviewItemBinding.inflate(inflater, parent, false));
    }
    ...
    class ServicesViewHolder extends RecyclerView.ViewHolder {
        private PreviewItemBinding requestItemBinding;

        ServicesViewHolder(@NonNull PreviewItemBinding requestItemBinding) {
