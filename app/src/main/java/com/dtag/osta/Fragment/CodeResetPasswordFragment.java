...
public class CodeResetPasswordFragment extends Fragment {
    ...
    private CodeResetPasswordViewModel mViewModel;

    public static CodeResetPasswordFragment newInstance() {
        return new CodeResetPasswordFragment();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.code_reset_password_fragment, container, false);
    }
